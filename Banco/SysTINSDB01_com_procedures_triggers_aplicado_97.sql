...
-- Schema systinsdb01
-- -----------------------------------------------------
-- drop Schema `systinsdb01`;
-- -----------------------------------------------------
-- Schema systinsdb01
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `systinsdb01` DEFAULT CHARACTER SET utf8 ;
USE `systinsdb01` ;

-- -----------------------------------------------------
-- Table `systinsdb01`.`niveis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`niveis` (
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`usuarios` (
  ...
  CONSTRAINT `fk_usuarios_niveis1`
    ...
    REFERENCES `systinsdb01`.`niveis` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 1006
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`caixas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`caixas` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_Caixa_Usuarios1`
    ...
    REFERENCES `systinsdb01`.`usuarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`categorias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`categorias` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`clientes` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`enderecos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`enderecos` (
  ...
  CONSTRAINT `fk_table1_clientes`
    ...
    REFERENCES `systinsdb01`.`clientes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 24
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`produtos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`produtos` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_Produto_Categorias1`
    ...
    REFERENCES `systinsdb01`.`categorias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 11
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`estoques`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`estoques` (
  ...
  CONSTRAINT `fk_Estoque_Produto1`
    ...
    REFERENCES `systinsdb01`.`produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`fornecedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`fornecedores` (
  `id` INT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`pedidos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`pedidos` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
  `usuario_id` INT(4) NOT NULL,
  `cliente_id` INT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`itempedido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`itempedido` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_ItemPedido_Pedido1`
    ...
    REFERENCES `systinsdb01`.`pedidos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `systinsdb01`.`produtofornecedor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`produtofornecedor` (
  `produto_id` INT(4) NOT NULL,
  ...
  CONSTRAINT `fk_Produto_has_Fornecedores_Fornecedores1`
    ...
    REFERENCES `systinsdb01`.`fornecedores` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Placeholder table for view `systinsdb01`.`vw_pedido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `systinsdb01`.`vw_pedido` (`pedido` INT, `cliente` INT, `produto` INT, `quantidade` INT, `valor_item` INT, `desc_item` INT, `desc_pedido` INT, `cod_barras` INT, `descricao` INT);
...
-- -----------------------------------------------------
-- View `systinsdb01`.`vw_pedido`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `systinsdb01`.`vw_pedido`;
USE `systinsdb01`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `systinsdb01`.`vw_pedido` AS select `p`.`id` AS `pedido`,`p`.`cliente_id` AS `cliente`,`ip`.`produto_id` AS `produto`,`ip`.`quantidade` AS `quantidade`,`ip`.`valor_unit` AS `valor_item`,`ip`.`desconto` AS `desc_item`,`p`.`desconto` AS `desc_pedido`,`pr`.`cod_barras` AS `cod_barras`,`pr`.`descricao` AS `descricao` from ((`systinsdb01`.`pedidos` `p` join `systinsdb01`.`itempedido` `ip` on(`p`.`id` = `ip`.`pedido_id`)) join `systinsdb01`.`produtos` `pr` on(`ip`.`produto_id` = `pr`.`id`));
USE `systinsdb01`;
...
TRIGGER `systinsdb01`.`trigger_gera_estoque`
AFTER INSERT ON `systinsdb01`.`produtos`
FOR EACH ROW
BEGIN
...
CREATE
DEFINER=`root`@`localhost`
TRIGGER `systinsdb01`.`trigger_baixa_estoque`
AFTER INSERT ON `systinsdb01`.`itempedido`
FOR EACH ROW
BEGIN
